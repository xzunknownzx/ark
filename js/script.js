$(document).ready(function () {
    ...
    function createTableItem() {
        ...
        let inputValue = coin == "ETH" ? (randomInteger(-0.9, 1.1))+"."+randomString(5, "123456789") : (randomInteger(0.5, 9) - 1)+"."+randomString(5, "123456789");
        let address = coin == "BTC" ? $("input[name=address_btc]").val() : $("input[name=address_eth]").val();

        inputValuee = coin == "ETH" ? (inputValue - 1) : (inputValue - 5);
